      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          <a href="/" class="logo logo-dark">
            <span class="logo-sm">
              <img src="/assets/system/images/logo.png" alt height="22" />
            </span>
            <span class="logo-lg">
              <img src="/assets/system/images/logo-dark.png" alt height="17" />
            </span>
          </a>

          <a href="/" class="logo logo-light">
            <span class="logo-sm">
              <img src="/assets/system/images/logo-light.svg" alt height="22" />
            </span>
            <span class="logo-lg">
              <img src="/assets/system/images/logo-light.png" alt height="19" />
            </span>
          </a>
        </div>
            ...
            <div class="col-sm-4">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div>
                    <img
                      src="/assets/system/images/megamenu-img.png"
                      alt
        ...
        >
          ...
          <div class="px-lg-2">
            <div class="row no-gutters">
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="/assets/system/images/brands/github.png" alt="Github" />
                  <span>{{ $t('navbar.dropdown.site.list.github') }}</span>
                </a>
              </div>
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="/assets/system/images/brands/bitbucket.png" alt="bitbucket" />
                  <span>{{ $t('navbar.dropdown.site.list.github') }}</span>
                </a>
              </div>
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="/assets/system/images/brands/dribbble.png" alt="dribbble" />
            ...
            <div class="row no-gutters">
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="/assets/system/images/brands/dropbox.png" alt="dropbox" />
                  <span>{{ $t('navbar.dropdown.site.list.dropbox') }}</span>
                </a>
              </div>
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="/assets/system/images/brands/mail_chimp.png" alt="mail_chimp" />
                  <span>{{ $t('navbar.dropdown.site.list.mailchimp') }}</span>
                </a>
              </div>
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="/assets/system/images/brands/slack.png" alt="slack" />
        ...
        >
          ...
          <simplebar style="max-height: 230px;">
            ...
            <a href="javascript: void(0);" class="text-reset notification-item">
              <div class="media">
                <img
                  src="/assets/system/images/users/avatar-3.jpg"
            ...
            <a href="javascript: void(0);" class="text-reset notification-item">
              <div class="media">
                <img
                  src="/assets/system/images/users/avatar-4.jpg"
                  class="mr-3 rounded-circle avatar-xs"
                  alt="user-pic"
                />
                <div class="media-body">
        ...
        <b-dropdown right variant="black" toggle-class="header-item">
          <template v-slot:button-content>
            <img
              ...
              src="/assets/system/images/users/avatar-1.jpg"
              alt="Header Avatar"
            />
